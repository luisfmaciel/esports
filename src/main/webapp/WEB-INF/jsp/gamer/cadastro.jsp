		...
		<form action="/gamer/incluir" method="post">
			...
			<div class="d-flex mt-3" style="gap: 50px;">
				<div class="mb-3 form-check">
					...
					<br>
					<div>
				    	<input type="checkbox" value="" class="form-check-input" id="exampleCheck1">
					    <label class="form-check-label" for="exampleCheck1">CS:GO</label>
					</div>
					<div>
				...
				<div class="mb-3 form-check">
					...
					<div>
					    ...
					    <label class="form-check-label" for="exampleCheck4">CS:GO</label>
					</div>
					<div>
					...
					<div>
					    ...
					    <label class="form-check-label" for="exampleCheck6">DUNGEOS</label>
					</div>
		  		</div>
				<div class="mb-3 form-check">
					...
					<div>
					    ...
					    <label class="form-check-label" for="exampleCheck9">DUNGEOS</label>
					</div>
		  		</div>
			</div> -->
